  ...
  return (
    <section id="top" className="relative overflow-hidden">
      ...
      >
        <img
          src="/logo.png"
          alt="TAKO Hibachi Sushi logo"
          onError={(event) => {
            event.currentTarget.style.display = "none";
          }}
          className="mb-6 h-24 w-24 rounded-full object-cover ring-2 ring-white/15 shadow-lg shadow-crimson/30"
        />
        <p className="mb-4 text-xs font-bold tracking-[0.35em] text-flame">
          509 SPARTA ST · MCMINNVILLE, TN
        </p>
        ...
        <p className="mt-6 max-w-xl text-base text-neutral-300 sm:text-lg">
          ...
          the truck. Order online for pickup, or call ahead and your food is
          ready when you are.
        </p>
        ...
        <a
          href="#reviews"
          className="mt-6 text-sm text-neutral-400 transition hover:text-flame"
        >
          ★ 4.6 on Google · Delivery available on DoorDash
        </a>
      </motion.div>
    </section>
  );
